    ...
    <TableContainer component={Paper} sx={{ maxWidth: '100%', maxHeight:'250px' }}>
      <Table sx={{ minWidth: 300, height: 100, overflowX:'scroll' }} aria-label="simple table">
        <TableHead sx={{ backgroundColor: 'black', color: 'white' }}>
          <TableRow>
            <TableCell align="center" sx={{ color: 'white' }}>Party</TableCell>
        ...
        <TableFooter>
          <TableRow>
            <TableCell align="center" sx={{ backgroundColor: 'black', color: 'white', cursor: 'pointer' }} colSpan={3} ><Link style={{ color: 'white' }} className='link-tab' to={`/${nav}`}>View All Details</Link></TableCell>
          </TableRow>
        </TableFooter>
      </Table>
    </TableContainer>
